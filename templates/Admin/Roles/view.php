                        ...
                        <div class="table-responsive">
                          ...
                          <table class="table table-hover table-bordered" id="sampleTable">
                            ...
                            <tr>
                              ...
                              <td class="actions">
                                <?= $this->Html->link('', ['action' => 'edit', $role->id], ['class' => 'btn btn-warning fa fa-pencil']) ?>
                                <?= $this->Form->postLink('', ['action' => 'delete', $role->id], ['confirm' => __('¿Estás seguro de que quieres eliminar # {0}?', $role->id), 'class' => 'btn btn-danger fa fa-trash']) ?>
                              </td>
                            </tr>
                          </table>
                            ...
                            <table class="table table-hover table-bordered" id="sampleTable">
                              ...
                              <?php foreach ($role->users as $users) : ?>
                                <tr>
                                  ...
                                  <td><?= h($users->secondname) ?></td>
                                  <td class="actions">
                                    <?= $this->Html->link('', ['action' => 'view', $users->id], ['class' => 'btn btn-info fa fa-eye']) ?>
                                    <?= $this->Html->link('', ['action' => 'edit', $users->id], ['class' => 'btn btn-warning fa fa-pencil']) ?>
                                    <?= $this->Form->postLink('', ['action' => 'delete', $users->id], ['confirm' => __('¿Estás seguro de que quieres eliminar # {0}?', $users->id), 'class' => 'btn btn-danger fa fa-trash']) ?>
                                  </td>
                                </tr>
                              <?php endforeach; ?>
                            </table>
