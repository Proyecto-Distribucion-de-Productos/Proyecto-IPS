            ...
            <li><a class="app-notification__item" href="javascript:;"><span class="app-notification__icon"><span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x text-primary"></i><i class="fa fa-envelope fa-stack-1x fa-inverse"></i></span></span>
              ...
              <aside class="app-sidebar">
                ...
                <ul class="app-menu">
                  ...
                  <li><a class="app-menu__item active" href="categories"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Categorias</span></a></li>
                            ...
                            <tbody>
                              <?php foreach ($categories as $category): ?>
                                <tr>
                                  ...
                                  <td class="actions">
                                    <?= $this->Html->link('', ['action' => 'view', $category->id], ['class' => 'btn btn-info fa fa-eye']) ?>
                                    <?= $this->Html->link('', ['action' => 'edit', $category->id], ['class' => 'btn btn-warning fa fa-pencil']) ?>
                                    <?= $this->Form->postLink('', ['action' => 'delete', $category->id], ['confirm' => __('¿Estás seguro de que quieres eliminar # {0}?', $category->id), 'class' => 'btn btn-danger fa fa-trash']) ?>
                                  </td>
                                </tr>
                              <?php endforeach; ?>
                            </tbody>
