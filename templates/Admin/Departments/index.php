          ...
          <div class="app-notification__content">
            <li><a class="app-notification__item" href="javascript:;"><span class="app-notification__icon"><span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x text-primary"></i><i class="fa fa-envelope fa-stack-1x fa-inverse"></i></span></span>
              ...
              <main class="app-content">
                <div class="app-title">
                  <div>
                    <h1><i class="fa fa-th-list"></i> Departamentos</h1>
                            ...
                            <tbody>
                              <?php foreach ($departments as $department): ?>
                                <tr>
                                  ...
                                  <td class="actions">
                                    <?= $this->Html->link('', ['action' => 'view', $department->id], ['class' => 'btn btn-info fa fa-eye']) ?>
                                    <?= $this->Html->link('', ['action' => 'edit', $department->id], ['class' => 'btn btn-warning fa fa-pencil']) ?>
                                    <?= $this->Form->postLink('', ['action' => 'delete', $department->id], ['confirm' => __('¿Estás seguro de que quieres eliminar # {0}?', $department->id), 'class' => 'btn btn-danger fa fa-trash']) ?>
                                  </td>
                                </tr>
                              <?php endforeach; ?>
                            </tbody>
