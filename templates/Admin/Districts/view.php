              ...
              <main class="app-content">
                <div class="app-title">
                  ...
                  <ul class="app-breadcrumb breadcrumb">
                    ...
                    <li><?= $this->Html->link('/Distritos', ['controller' => 'Districts', 'action' => 'index'], ['class' => 'breadcrumb-item active']) ?></li>
                  </ul>
                </div>
                <div class="row">
                  <div class="col-md-12">
                        ...
                        <div class="table-responsive">
                          ...
                          <table class="table table-hover table-bordered" id="sampleTable">
                            ...
                            <tr>
                              ...
                              <td><?= $district->has('department') ? $this->Html->link($district->department->name, ['controller' => 'Departments', 'action' => 'view', $district->department->id]) : '' ?>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              ...
                              <td class="actions">
                                <?= $this->Html->link('', ['action' => 'edit', $district->id], ['class' => 'btn btn-warning fa fa-pencil']) ?>
                                <?= $this->Form->postLink('', ['action' => 'delete', $district->id], ['confirm' => __('¿Estás seguro de que quieres eliminar # {0}?', $district->id), 'class' => 'btn btn-danger fa fa-trash']) ?>
                              </td>
                            </tr>
                          </table>
