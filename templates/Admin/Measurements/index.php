          ...
          <div class="app-notification__content">
            <li><a class="app-notification__item" href="javascript:;"><span class="app-notification__icon"><span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x text-primary"></i><i class="fa fa-envelope fa-stack-1x fa-inverse"></i></span></span>
              ...
              <main class="app-content">
                <div class="app-title">
                  <div>
                    <h1><i class="fa fa-th-list"></i> Medidas</h1>
                    <!--<p>Basic bootstrap tables</p>-->
                  </div>
                  <ul class="app-breadcrumb breadcrumb">
                    <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
                    <!--<li class="breadcrumb-item">Tables</li>-->
                    <li><?= $this->Html->link('/Medidas', ['controller' => 'Measurements', 'action' => 'index'], ['class' => 'breadcrumb-item active']) ?></li>
                  </ul>
                </div>
                <div class="row">
                  <div class="col-md-12">
                            ...
                            <tbody>
                              <?php foreach ($measurements as $measurement): ?>
                                <tr>
                                  ...
                                  <td class="actions">
                                    <?= $this->Html->link('', ['action' => 'view', $measurement->id], ['class' => 'btn btn-info fa fa-eye']) ?>
                                    <?= $this->Html->link('', ['action' => 'edit', $measurement->id], ['class' => 'btn btn-warning fa fa-pencil']) ?>
                                    <?= $this->Form->postLink('', ['action' => 'delete', $measurement->id], ['confirm' => __('¿Estás seguro de que quieres eliminar # {0}?', $measurement->id), 'class' => 'btn btn-danger fa fa-trash']) ?>
                                  </td>
                                </tr>
                              <?php endforeach; ?>   
                            </tbody>
