                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $purchase->has('provider') ? $this->Html->link($purchase->provider->name, ['controller' => 'Districts', 'action' => 'view', $purchase->provider->id]) : '' ?></td>
                        <td><?= h($purchase->date) ?></td>
                        <td><?= $purchase->has('user') ? $this->Html->link($purchase->user->name, ['controller' => 'Provinces', 'action' => 'view', $purchase->user->id]) : '' ?></td>
                      
                        <td class="actions">
                            <?= $this->Html->link('', ['action' => 'view', $purchase->id], ['class' => 'btn btn-info fa fa-eye']) ?>
