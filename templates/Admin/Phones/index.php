                            ...
                            <tbody>
                              <?php foreach ($phones as $phone): ?>
                                <tr>
                                  ...
                                  <td class="actions">
                                    <?= $this->Html->link('', ['action' => 'view', $phone->id], ['class' => 'btn btn-info fa fa-eye']) ?>
                                    <?= $this->Html->link('', ['action' => 'edit', $phone->id], ['class' => 'btn btn-warning fa fa-pencil']) ?>
                                    <?= $this->Form->postLink('', ['action' => 'delete', $phone->id], ['confirm' => __('¿Estás seguro de que quieres eliminar # {0}?', $phone->id), 'class' => 'btn btn-danger fa fa-trash']) ?>
                                  </td>
                                </tr>
                              <?php endforeach; ?>
