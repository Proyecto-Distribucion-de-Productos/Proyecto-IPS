            ...
            <li><a class="app-notification__item" href="javascript:;"><span class="app-notification__icon"><span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x text-primary"></i><i class="fa fa-envelope fa-stack-1x fa-inverse"></i></span></span>
              ...
              <aside class="app-sidebar">
                ...
                <ul class="app-menu">
                  ...
                  <li><?= $this->Html->link($this->Html->tag('i', '', ['class' => 'app-menu__icon fa fa-shopping-cart']).$this->Html->tag('span', 'Compras Productos', ['class' => 'app-menu__label']), ['controller' => 'ProductsPurchases', 'action' => 'index'], ['class' => 'app-menu__item active', 'escape' => false]) ?></li>
                </ul>
              </aside>
              <!-- End Sidebar menu-->
              <main class="app-content">
                <div class="app-title">
                  <div>
                    <h1><i class="fa fa-th-list"></i>products_purchases</h1>
                    <!--<p>Basic bootstrap tables</p>-->
                  </div>
                  <ul class="app-breadcrumb breadcrumb">
                    <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
                    <!--<li class="breadcrumb-item">Tables</li>-->
                    <li class="breadcrumb-item active"><a href="#">products_purchases</a></li>
                  </ul>
                </div>
                <div class="row">
                  <div class="col-md-12">
