    ...
    <section class="project-detail">
        <div class="auto-container">
            <div class="sec-title text-center">
                <h2>Mapa de ubicación de proveedores por departamento del Perú</h2>
            </div>
...
<script type="text/javascript">
    function graficarTablaAlertas(valores, valord, departamento) {
        ...
        for (let i = 0; i < valores.length; i++) {
            if(valores[i][3] == valord){
                myTable+="<tr><td>" + valores[i][0] + "</td>"; 
                myTable+="<td>" + valores[i][1] + "</td>"; 
                myTable+="<td>" + valores[i][2] + "</td>"; 
    ...
    function printTable(tableValues){
        tableValues = "<table class='table table-hover table-bordered'><thead><tr><td scope='col'>Ruc</td><td scope='col'>Nombre</td><td scope='col'>Dirección</td><td scope='col'>Departamento</td></tr></thead>"+tableValues+"</table>";
    ...
    anychart.data.loadJsonFile('../home/json/peru.json', function (data) {
        ...
        function changeContent(ids) {
            ...
            for (var i = 0; i < ids.length; i++) {
                ...
                //alert(data['value']);
                datosTable += graficarTablaAlertas(providers, data['value'], data['name']);
            } 
