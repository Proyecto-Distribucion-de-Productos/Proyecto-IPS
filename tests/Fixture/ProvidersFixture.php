...
class ProvidersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'direction' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_0900_ai_ci', 'comment' => '', 'precision' => null],
        '_indexes' => [
        ...
        '_constraints' => [
            ...
            'providers_ibfk_1' => ['type' => 'foreign', 'columns' => ['district_id'], 'references' => ['districts', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'providers_ibfk_2' => ['type' => 'foreign', 'columns' => ['province_id'], 'references' => ['provinces', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'providers_ibfk_3' => ['type' => 'foreign', 'columns' => ['department_id'], 'references' => ['departments', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
